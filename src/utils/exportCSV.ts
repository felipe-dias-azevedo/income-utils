...
export function exportToCSV(incomes: ComputedIncome[]): void {
  ...
  const fieldLabelMap: Record<keyof ComputedIncome, string> = {
    ...
    overtimeHour: "Horas Extras/Hora",
    grossMonth: "Salário/Mês",
    netMonth: "Salário/Mês Líquido",
    grossMonthTotal: "Salário/Mês Total",
    netMonthTotal: "Salário/Mês Total Líquido",
    benefits: "Benefícios",
    grossMonthPlusBenefits: "Total/Mês",
    netMonthPlusBenefits: "Total/Mês Líquido",
    grossMonthTotalPlusBenefits: "Total/Mês Total",
    netMonthTotalPlusBenefits: "Total/Mês Total Líquido",
    ...
    commuterBenefit: "Vale Transporte",
    contractType: "Tipo de Contrato",
    taxTableType: "Tabela de Imposto",
    id: "ID",
